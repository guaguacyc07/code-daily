...
![image-20260916210510827](./img/24.%20Palindrome%20Linked%20List.assets/image-20260916210510827.png)
...
- **时间复杂度：O(n)**
  ...
  找中点、迭代反转后半段、比较，各一趟遍历。

- **空间复杂度：O(1)**

  迭代反转只用 pre、cur、nxt 三个指针（对比解法二省掉了 O(n) 的递归栈）。
